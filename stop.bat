...
taskkill /FI "WindowTitle eq KeywordDetectionFrontendMobile*" /T /F > nul 2>&1
taskkill /FI "WindowTitle eq KeywordDetectionVite*" /T /F > nul 2>&1
taskkill /FI "WindowTitle eq KeywordDetectionElectron*" /T /F > nul 2>&1
taskkill /FI "WindowTitle eq KeywordDetectionTunnel*" /T /F > nul 2>&1
taskkill /FI "WindowTitle eq KeywordDetectionServices*" /T /F > nul 2>&1
